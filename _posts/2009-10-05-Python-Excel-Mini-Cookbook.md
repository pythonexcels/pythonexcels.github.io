...
* I tested these examples in Excel versions 2016 and 2007, they should work
...
The following script simply invokes Excel, adds a workbook and saves
the empty workbook in your Documents folder.

[add_a_workbook.py](https://github.com/pythonexcels/examples/blob/master/add_a_workbook.py)
...
This script opens an existing workbook and displays it by specifying
...
[open_an_existing_workbook.py](https://github.com/pythonexcels/examples/blob/master/open_an_existing_workbook.py)
...
[add_a_worksheet.py](https://github.com/pythonexcels/examples/blob/master/add_a_worksheet.py)
...
[ranges_and_offsets.py](https://github.com/pythonexcels/examples/blob/master/ranges_and_offsets.py)
...
[autofill_cells.py](https://github.com/pythonexcels/examples/blob/master/autofill_cells.py)
...
[cell_color.py](https://github.com/pythonexcels/examples/blob/master/cell_color.py)
...
[column_widths.py](https://github.com/pythonexcels/examples/blob/master/column_widths.py)
...
[copy_worksheet_to_worksheet.py](https://github.com/pythonexcels/examples/blob/master/copy_worksheet_to_worksheet.py)
...
size used in the worksheet. The script uses five different fonts and sizes, and
formats numbers using a monetary format.

[format_cells.py](https://github.com/pythonexcels/examples/blob/master/format_cells.py)
...
[row_height.py](https://github.com/pythonexcels/examples/blob/master/row_height.py)
